...
class EntChildPending(EntPending[EntChildModel]):
    m = EntChildModel
...
class EntChild(
    PrivacyMixin, EntObjectBase[ExampleViewerContext, EntChildModel], EntChildPending
):
    m = EntChildModel
